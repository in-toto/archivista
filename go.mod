...
replace github.com/davepgreene/go-db-credential-refresh => ./internal/third_party/go-db-credential-refresh

replace github.com/davepgreene/go-db-credential-refresh/store/awsrds => ./internal/third_party/go-db-credential-refresh/store/awsrds
